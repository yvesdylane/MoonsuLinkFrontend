...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* ── Features ── */}
      <section id="features" className="border-t border-zinc-100 bg-zinc-50 pb-0 pt-24 dark:border-zinc-700 dark:bg-primary-dark">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div data-reveal>
      ...
      {/* ── See It Live ── */}
      <section className="relative overflow-visible bg-white pt-4 pb-16 dark:bg-primary">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="mt-8 space-y-4">
                <a href="https://wa.me/621606279" target="_blank" rel="noopener noreferrer">
                  <DoubleBezelCard
                    data-reveal
                    data-delay="100ms"
                    data-reveal-left
                    className="border border-zinc-200 bg-zinc-50 p-4 backdrop-blur-lg dark:border-white/10 dark:bg-white/5 cursor-pointer transition hover:bg-zinc-100 dark:hover:bg-white/10"
                  >
                ...
                <a href="https://t.me/MoonsuLink_bot" target="_blank" rel="noopener noreferrer">
                  <DoubleBezelCard
                    data-reveal
                    data-delay="200ms"
                    data-reveal-left
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-primary dark:text-white">Find @MoonsuLinkBot on Telegram</p>
            ...
            {/* Image content - now directly opposite on the right */}
            <div 
              data-reveal 
              data-delay="300ms" 
              data-reveal-scale 
            ...
            >
              <Image
                ...
                className="h-auto w-full max-w-[320px] rounded-3xl shadow-tinted animate-float max-lg:animate-none"
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
            <div className="flex items-center gap-1.5">
              <span className="text-lg font-bold tracking-tight text-primary dark:text-white">Moonsu</span>
              <span className="text-lg font-bold tracking-tight text-accent">Link</span>
            </div>
            <div className="flex items-center gap-4">
              <a href="https://wa.me/621606279" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-xs text-zinc-500 transition hover:text-[#25D366] dark:text-zinc-400 dark:hover:text-[#25D366]">
              ...
              <a href="https://t.me/MoonsuLink_bot" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-xs text-zinc-500 transition hover:text-[#2AABEE] dark:text-zinc-400 dark:hover:text-[#2AABEE]">
                <svg aria-hidden="true" viewBox="0 0 24 24" fill="currentColor" className="h-3.5 w-3.5">
                  <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z" />
                </svg>
                Telegram
