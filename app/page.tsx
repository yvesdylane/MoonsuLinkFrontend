...
function WhatsAppMockup() {
  return (
    <div className="animate-float mx-auto w-full max-w-[320px] overflow-hidden rounded-3xl border-4 border-zinc-800 bg-white shadow-2xl dark:border-zinc-600">
      ...
      <div className="space-y-3 bg-[#e5ddd5] bg-[url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI1IiBoZWlnaHQ9IjUiPjxyZWN0IHdpZHRoPSI1IiBoZWlnaHQ9IjUiIGZpbGw9IiNlNWRkZDUiLz48cGF0aCBkPSJNMCA1TDUgMFpNNiA0TDQgNlpNLTEsMUwxLC0xWiIgc3Ryb2tlPSIjYzJhYjkyIiBzdHJva2Utd2lkdGg9IjEuMjUiLz48L3N2Zz4=')] p-4 dark:opacity-90">
        <div className="flex">
          <div className="max-w-[85%] rounded-br-2xl rounded-tr-2xl rounded-tl-sm bg-white px-3.5 py-2.5 shadow-sm">
            <p className="text-[13px] leading-relaxed text-zinc-800">I want to sell 50kg of corn at 250 XAF per kg</p>
...
function TelegramMockup() {
  return (
    <div className="animate-float mx-auto w-full max-w-[320px] overflow-hidden rounded-3xl border-4 border-zinc-800 bg-white shadow-2xl dark:border-zinc-600" style={{ animationDelay: '-2s' }}>
        ...
        <div className="flex">
          <div className="max-w-[85%] rounded-2xl bg-[#F0F0F0] px-3.5 py-2.5">
            ...
            <div className="mt-2 space-y-1 border-l-2 border-[#2AABEE] pl-3">
              ...
              <p className="text-[12px] font-medium text-zinc-800">West: 130-220 XAF/kg</p>
            </div>
...
function splitChars(text: string): string {
  return [...text]
    .map((char, i) =>
      `<span class="split-char" style="--i:${i}">${char === ' ' ? '&nbsp;' : char}</span>`
    )
    .join('')
}
...
export default function HomePage() {
  useEffect(() => {
    const destroy = initScrollReveal()
    return destroy
  }, [])
  ...
  return (
    <>
      ...
      {/* ── Hero ── */}
      <section className="relative flex min-h-screen items-center bg-primary-dark pb-24 pt-32 sm:pt-40">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,_rgba(154,243,118,0.08),_transparent_60%)]" />
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <h1
                data-reveal
                data-delay="100ms"
                className="mt-4 text-balance text-4xl font-bold leading-[1.1] tracking-tight text-white sm:text-5xl lg:text-[clamp(2.5rem,5vw,5rem)]"
                dangerouslySetInnerHTML={{
                  __html: splitChars('Your farm marketplace, inside your chat app'),
                }}
              />
              <p
                data-reveal
                data-delay="300ms"
                className="mt-6 max-w-[65ch] text-base leading-relaxed text-zinc-300 sm:text-lg"
              >
              ...
              >
                <a
                  href="#how-it-works"
                  className="inline-flex items-center gap-2 rounded-2xl bg-accent px-6 py-3.5 text-sm font-semibold text-primary transition hover:bg-accent-hover active:scale-[0.97]"
                >
                  See how it works
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2">
          <div className="animate-scroll-indicator flex flex-col items-center gap-1">
            ...
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-4 w-4 text-zinc-500">
      ...
      <section id="how-it-works" className="bg-white py-24 dark:bg-primary">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2">
            <div
              data-reveal
              className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-lg dark:bg-white/5"
            >
              <div className="flex items-center gap-3">
      ...
      <section id="features" className="border-t border-zinc-100 bg-zinc-50 py-24 dark:border-zinc-700 dark:bg-primary-dark">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2">
            <div
              data-reveal
              className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-lg dark:bg-white/5 md:col-span-2"
            >
              <div className="grid gap-8 md:grid-cols-2 md:items-center">
                ...
                <div className="hidden md:block">
                  <div className="rounded-2xl bg-primary-dark/50 p-6">
                    ...
                    <p className="mt-2 rounded-xl bg-white/10 px-4 py-3 text-sm shadow-sm backdrop-blur-sm">
            ...
            <div data-reveal data-delay="80ms" className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-lg dark:bg-white/5">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-accent/10 text-accent-dark dark:text-accent">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="h-6 w-6">
            ...
            <div data-reveal data-delay="160ms" className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-lg dark:bg-white/5">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-accent/10 text-accent-dark dark:text-accent">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="h-6 w-6">
            ...
            <div data-reveal data-delay="240ms" className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-lg dark:bg-white/5">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-accent/10 text-accent-dark dark:text-accent">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="h-6 w-6">
            ...
            <div data-reveal data-delay="320ms" className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-lg dark:bg-white/5">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-accent/10 text-accent-dark dark:text-accent">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="h-6 w-6">
            ...
            <div data-reveal data-delay="400ms" className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-lg dark:bg-white/5">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-accent/10 text-accent-dark dark:text-accent">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="h-6 w-6">
      ...
      <section className="bg-white py-24 dark:bg-primary">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-8 space-y-4">
                <div
                  ...
                  data-delay="100ms"
                  data-reveal-left
                  className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-lg"
                >
            ...
            <div data-reveal data-delay="300ms" data-reveal-scale>
              <TelegramMockup />
            </div>
          </div>
        </div>
              ...
              <span
                ...
                className={`rounded-full border px-4 py-2 text-xs font-medium transition hover:-translate-y-0.5 ${
                  r === 'Centre' || r === 'Littoral'
                    ...
                    : 'border-white/10 bg-white/5 text-zinc-400 dark:bg-white/5'
                }`}
              >
                {r}
              </span>
      ...
      {/* ── Footer ── */}
      <footer className="border-t border-white/10 bg-white py-12 dark:bg-primary">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
